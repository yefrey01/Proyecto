...
<body>
		...
		<div class="container mb40">
				...
				<div class="col-xs-6 hidden-xs">
					<div class="row">
						<div class="col-sm-9 col-md-6 mt10">
							<h3 class="titulo">Editar Novedad</h3>
						</div>
					</div>
				</div>
				<div class="col-xs-6">
			...
			<div class="row formu">
				...
				<input type="hidden" name="id_novedad" value="<?php echo "$var_idnovedad"; ?>">
									...
									<div class="grupo">
										<div class="row">
											...
											<div class="col-sm-4">
													<div class="item">
														<label>
															<input type="radio" name="rad_tiponovedad" value="<?php echo $V_datostnovedad[$j]['id_tiponovedad']; ?>" <?php if($j == 1 ){ ?> id="tipo_novedad" class="check activar" <?php }else{ ?> class="check" <?php } if($V_datosnovedad['id_tiponovedad']==$V_datostnovedad[$j]['id_tiponovedad']) {?> checked <?php } ?> title="Tipo Novedad es obligatorio" required ><!-- Falta el Cheked aqui checked -->
														</label>
													...
													<label>
														<div class="combo">
															<select name="sel_sreporta" class="selec" tittle="Sección Reporta es obligatorio" required>
																	...
																	<option value="<?php echo $V_datossreporta[$i]['id_seccionreporta']; ?>" <?php if($V_datosnovedad['id_seccionreporta']==$V_datossreporta[$i]['id_seccionreporta']){?> selected <?php } ?> ><?php echo $V_datossreporta[$i]['descripcion']; ?></option>
																<?php } ?>
															</select>
														</div>	
												    </label>
									...
									<div class="grupo">
										<div class="row">
											...
											<div class="col-sm-8">
												<div class="item">
													<label>
														<input type="text" name="txt_fecha" class="fechaInd" value="<?php echo $V_datosnovedad['fecha']; ?>" title="Fecha es obligatoria" required ><!--readonly-->
													</label>
												</div>
											</div>
														...
														<label>
															<div class="combo">
																<select id="sel_porigen" name="sel_porigen" class="selec" tittle="Proceso Origen es obligatorio" required>
																		...
																		<option value="<?php echo $V_datosporigen[$i]['id_procesoorigen']; ?>" <?php if($V_datosnovedad['id_procesoorigen'] == $V_datosporigen[$i]['id_procesoorigen']){ ?> selected <?php } ?> ><?php echo $V_datosporigen[$i]['descripcion']; ?></option>
																	<?php } ?>
																</select>
															</div>	
													    </label>
												...
												<label>
													<div class="combo">
														<select id="sel_sorigen" name="sel_sorigen" class="selec" tittle="Seccion Origen es obligatorio" required>
															...
															<option value="<?php echo $V_datossorigen[$i]['id_seccionorigen']; ?>" <?php if($V_datosnovedad['id_seccionorigen'] == $V_datossorigen[$i]['id_seccionorigen']){ ?> selected <?php } ?> ><?php echo $V_datossorigen[$i]['descripcion']; ?></option>
																<?php } ?>
											...
											<label>
												<div class="combo">
													...
													<?php for($i=0;$i<$tamcnovedad;$i++){ 
														if($V_datosnovedad['id_seccionorigen']==$V_datoscnovedad[$i]['id_seccionorigen']){?>	
														<option value="<?php echo $V_datoscnovedad[$i]['id_causanovedad'];?>" <?php if($V_datosnovedad['id_causanovedad'] == $V_datoscnovedad[$i]['id_causanovedad']){ ?> selected <?php } ?> > <?php echo $V_datoscnovedad[$i]['descripcion']; ?></option>
														<?php } }?>
															<?php foreach ($Respuesta as $datoscnovedad):?>
															<option value="<?php echo $datoscnovedad->id_causanovedad; ?>" <?php if($V_datosnovedad['id_causanovedad'] == $$datoscnovedad->id_causanovedad){ ?> selected <?php } ?>><?php echo $datoscnovedad->descripcion;?></option>
														<?php endforeach;?>
													</select>
												</div>	
										    </label>
									...
									<div class="grupo">
										<div class="row">
											...
											<div class="col-sm-10">
											   <div class="item">
												<label>
													<input type="text" value="<?php echo $V_datosnovedad['descripcion']; ?>" name="txt_descripcion"  tittle="Descripción es obligatorio" required>
												</label>
												</div>
											</div>
												...
												<label>
													<div class="combo">
														<select name="sel_requipo" class="selec" tittle="Referencia Equipo es obligatorio" required>
																...
																<option value="<?php echo $V_datosrequipo[$i]['id_referenciaequipo']; ?>" <?php if($V_datosnovedad['id_referenciaequipo'] == $V_datosrequipo[$i]['id_referenciaequipo']){ ?> selected <?php } ?> ><?php echo $V_datosrequipo[$i]['descripcion']; ?></option>
															<?php } ?>
														</select>
													</div>	
											    </label>
								...
								<div class="grupo">
									<div class="row">
										...
										<div class="col-sm-9">
											   <div class="item">
												<label>
													<input type="number" value="<?php echo $V_datosnovedad['num_piezas']; ?>" name="txt_npiezas" max="999999999"  tittle="Número Piezas es obligatorio" required>
												</label>
												</div>
										</div>
									</div>
							...
							<div class="grupo">
								<div class="row">
									...
									<div class="col-sm-9">
										   <div class="item">
											<label>
												<input type="number" value="<?php echo $V_datosnovedad['ordenproduccion']; ?>" name="txt_oproduccion" max="999999999"  tittle="Este campo es obligatorio" required>
											</label>
											</div>
									</div>
								</div>
												   ...
												   <div class="item">
													<label>
														...
														<select name="sel_tratamiento" class="selec" tittle="Tratamiento es obligatorio" required>
															...
															<option value="<?php echo $V_datostratamiento[$i]['id_tratamiento']; ?>" <?php if($V_datosnovedad['id_tratamiento'] == $V_datostratamiento[$i]['id_tratamiento']){ ?> selected <?php } ?> ><?php echo $V_datostratamiento[$i]['descripcion']; ?></option>
															<?php } ?>
														</select>
														</div>	
												    </label>
												...
												<label>
													<div class="combo">
														<select name="sel_cdetallada" class="selec" tittle="Causa Detallada es obligatorio" required>
																...
																<option value="<?php echo $V_datoscdetallada[$i]['id_causadetallada']; ?>" <?php if($V_datosnovedad['id_causadetallada'] == $V_datoscdetallada[$i]['id_causadetallada']){ ?> selected <?php } ?> ><?php echo $V_datoscdetallada[$i]['descripcion']; ?></option>
															<?php } ?>
														</select>
													</div>	
											    </label>
									...
									<div class="grupo">
										<div class="row">
											...
											<div class="col-sm-8">
												   <div class="item">
													<label>
														<input type="number" value="<?php echo $V_datosnovedad['dias']; ?>" name="txt_dia" max="999999999">
													</label>
													</div>
											</div>
										</div>
									...
									<div class="grupo">
										<div class="row">
											...
											<div class="col-sm-8">
											   <div class="item">
												<label>
													<input type="number" value="<?php echo $V_datosnovedad['horas']; ?>" name="txt_hora" max="999999999">
												</label>
												</div>
											</div>
										</div>
									...
									<div class="grupo">
										<div class="row">
											...
											<div class="col-sm-8">
											   <div class="item">
												<label>
													<input type="number" value="<?php echo $V_datosnovedad['minutos']; ?>" name="txt_min" max="999999999">
												</label>
												</div>
											</div>
										</div>
								...
								<div class="grupo">
									<div class="row">
										...
										<div class="col-sm-12 observaciones">
												<div class="item pl15">
													<label class="pr15">
														<textarea name="observaciones" value="<?php echo $V_datosnovedad['observaciones'] ?>"></textarea>
													</label>
