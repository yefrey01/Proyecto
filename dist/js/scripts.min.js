...
// @codekit-prepend "icheck.js"
	...
	function calculototalesviajes(Vlr_item, Vlr_mayor){
		var Valorunitario= $('#txt_valorunitario_'+Vlr_item).val();
		var Cantidad= $('#sel_cantidad_'+Vlr_item).val();	
		var Valortotal=	Cantidad*Valorunitario;

		$('#txt_valortotal_'+Vlr_item).val(Valortotal);
		var i=0;
		var sumatotal=0;
		while(i < Vlr_mayor){
			if($('#txt_valortotal_'+i).val()!=""){
				sumatotal=parseInt(sumatotal) + parseInt($('#txt_valortotal_'+i).val());
			}
			i++;
		}
		...
		var sumatotaluni=0;
		while(i < Vlr_mayor){
			if($('#txt_valorunitario_'+i).val()!=""){
				sumatotaluni=parseInt(sumatotaluni) + parseInt($('#txt_valorunitario_'+i).val());
			}
			i++;
		}

		$('#vtotaltotal').val(sumatotal);
		$('#vunitariototal').val(sumatotaluni);		
	}


	function calculototalesviajes_leg(Vlr_item, Vlr_mayor){
		var Valorunitario= $('#txt_valorunitario_'+Vlr_item).val();
		var Cantidad= $('#sel_cantidad_'+Vlr_item).val();	
		var Valortotal=	Cantidad*Valorunitario;
		...
		var i=0;
		var sumatotal=0;
		var tem_valortotal=0;
		while(i < Vlr_mayor){
			 tem_valortotal=$('#txt_valortotal_'+i).val();

			if((tem_valortotal>=0) && (tem_valortotal!="") && (tem_valortotal!=undefined)){
				sumatotal=parseInt(sumatotal) + parseInt(tem_valortotal);
			}
			i++;
		}
		...
		var i=0;
		var sumatotaluni=0;
		var tem_valorunitario=0;		
		while(i < Vlr_mayor){
			tem_valorunitario=$('#txt_valorunitario_'+i).val();


			if((tem_valorunitario>=0) && (tem_valorunitario!="") && (tem_valorunitario!=undefined)){
				sumatotaluni=parseInt(sumatotaluni) + parseInt(tem_valorunitario);
			}
			i++;
		}
	...
	function Aprobar_excedente(Vlr_item,Vlr_aprobacion){
			
			$('#loading').append('<img src="../css/images/loader.gif">');

			var toLoad= 'controlador.php?accion=1&idgastodeviaje='+Vlr_item+'&aprobacion='+Vlr_aprobacion;
			$.post(toLoad,function(responseText){
				if(responseText.trim()=='0'){
					//FALTA ENVIAR CORREOS.!!!!!!!! AH TESORERIA Y AL RESPONSABLE.
					$('#Resultado').append('Intente Nuevamente');
				}else{
					$('#aprobaritem').remove();
					$('#desaprobaritem').remove();
					$('#loading').remove();
									
					if(Vlr_aprobacion==1){
						$('#Resultado').append('Aprobado <img src="../css/images/icon-aprobado.png">');
					}else{
						$('#Resultado').append('Negado <img src="../css/images/icon-eliminar.png">');						
					}
				}
			});
	}
	...
	function Ejecucion_desembolso(Vlr_item){
			
			$('#loading'+Vlr_item).append('<img src="../css/images/loader.gif">');
				var toLoad= 'controlador.php?accion=2&idgastodeviaje='+Vlr_item;
				$.post(toLoad,function(responseText){
					if(responseText.trim()=='0'){
						//FALTA ENVIAR CORREOS.!!!!!!!! AH TESORERIA Y AL RESPONSABLE.
						$('#Resultado'+Vlr_item).append('Intente Nuevamente');
					}else{
						$('#img_aprobacion_'+Vlr_item).remove();
						$('#loading'+Vlr_item).remove();
						$('#Resultado'+Vlr_item).append('<img src="../css/images/icon-aprobado.png" alt="Aprobado">');
					}
				});			

	}	

	// Plan de acción, encuesta cliente.
	function guardar_situacion(Vlr_idencuesta, Vlr_idfichaservicio){
			
			//$('#loading').append('<div id="img_loading"><img src="../css/images/loader.gif"></div>');
			var var_situacion= $("#text_situacion").val();
			var toLoad= 'controlador.php?accion=1&idenc='+Vlr_idencuesta+'&idficha='+Vlr_idfichaservicio+'&situacion='+var_situacion;
			$.post(toLoad,function(responseText){
				if(responseText.trim()=='0'){
					$('#resultado').append('Intente Nuevamente');
				}else{
					//$('#loading').remove();
					$('#resultado').animate({height: "20px", opacity: 1}, "slow").append('<div id="det_resultado"><img src="../css/images/icon-aprobado.png"></div>');
					$("#resultado").delay(1000).animate({ height: "-1px", opacity: 0}, "slow");
				}
			});	

	}	

	function guardar_investigacion(Vlr_idencuesta, Vlr_idfichaservicio){
			
			//$('#loading_1').append('<div id="img_loading"><img src="../css/images/loader.gif"></div>');
			var var_conclusiones= $("#text_conclusiones").val();
			var toLoad= 'controlador.php?accion=2&idenc='+Vlr_idencuesta+'&idficha='+Vlr_idfichaservicio+'&conclusiones='+var_conclusiones;
			$.post(toLoad,function(responseText){
				if(responseText.trim()=='0'){
					$('#resultado_1').append('Intente Nuevamente');
				}else{
					//$('#loading_1').remove();
					$('#resultado_1').animate({height: "20px", opacity: 1}, "slow").append('<div id="det_resultado_1"><img src="../css/images/icon-aprobado.png"></div>');
					$("#resultado_1").delay(1000).animate({ height: "-1px", opacity: 0}, "slow");
				}
			});	

	}

	function guardar_planaccion(Vlr_idencuesta, Vlr_idfichaservicio){
			
			var var_plan_accion= $("#text_plan_accion").val();
			var var_sel_responsable= $("#sel_responsable").val();
			var txt_ffin= $("#txt_ffin").val();
			
			var toLoad= 'controlador.php?accion=3&idenc='+Vlr_idencuesta+'&idficha='+Vlr_idfichaservicio+'&plan_accion='+var_plan_accion+'&responsable='+var_sel_responsable+'&ffin='+txt_ffin;
			$.post(toLoad,function(responseText){
				if(responseText.trim()=='0'){
					$('#resultado_2').append('Intente Nuevamente');
				}else{
					$('#resultado_2').animate({height: "20px", opacity: 1}, "slow").append('<div id="det_resultado_2"><img src="../css/images/icon-aprobado.png"></div>');
					$("#resultado_2").delay(1500).animate({ height: "-1px", opacity: 0}, "slow");
				}
			});

	}

	function guardar_planaccion_datos(Vlr_idplan, Vlr_idencuesta){
			
			var var_porcentajeavance= $("#sel_porcentajeavance").val();
			var var_sel_satisfaccion= $("#sel_satisfaccion").val();
			var var_sel_cerrarcaso= $("#sel_cerrarcaso").val();
			var var_archivo= $("#filer_input2").val();
			var res = var_archivo.split(".");
			var_archivo=res[0];

			var toLoad= 'controlador.php?accion=4&idplan='+Vlr_idplan+'&idencuesta='+Vlr_idencuesta+'&porcentaje='+var_porcentajeavance+'&satisfaccion='+var_sel_satisfaccion+'&cerrarcaso='+var_sel_cerrarcaso+'&nombre_archivo='+var_archivo;
			$.post(toLoad,function(responseText){

				if(responseText.trim()=='0'){
					$('#resultado_3').append('Intente Nuevamente');
				}else{
					$('#resultado_3').animate({height: "20px", opacity: 1}, "slow").append('<div id="det_resultado_3"><img src="../css/images/icon-aprobado.png"></div>');
					$("#resultado_3").delay(1500).animate({ height: "-1px", opacity: 0}, "slow");
				}
			});
	...
	function deshabilitar_ficha(var_idficha){
			
			var var_idfichaservicio= var_idficha;

			var toLoad= 'controlador.php?accion=1&idficha='+var_idfichaservicio;
			$.post(toLoad,function(responseText){

				if(responseText.trim()=="1"){
					$("#c"+var_idficha).remove();
				}
...
$(document).ready(function(){
	...
	var conten_errores = $('.errores');
	 ...
	 $(".frmpass").validate({
	  ...
	  submitHandler: function(form) {
			var var_pass1=$('#txt_canterior').val();
				...
				if(responseText.trim()=='1111'){
					...
					if(responseText.trim()=='2222'){
						...
						if(responseText.trim()=='3333'){
							$('.errores,.revisar ul').css("display","block");
							$('.revisar ul').append('<li>La contraseña anterior no corresponde</li>');	
						}						
					}
				}
			});
	...
	$('.activar_usuario').on('ifClicked', function(event){

			var id=$(this).attr('data-idtercero');
			var estado=$(this).attr('data-estado');

			var toLoad= 'controlador.php?accion=2&idtercero='+id+'&estado='+estado;
			$.post(toLoad,function(responseText){
				// Aqui si quiero pongo algo, pero ahi se hace el cambio de una.!!!
			});
	...
	function filterGlobal () {
	  ...
	  $('#tabla_general').DataTable().search(
	   $('#global_filter').val()
	  ).draw();
	...
	var oTable = $("#tabla_cotizacion").dataTable();
	 oTable.on('click', '.duplicar',function(e){ 
	  e.preventDefault();
	  $(this).parent('.duplicarficha').submit();
	 });
	...
	var oTable = $("#tabla_general").dataTable();
	 oTable.on('click', '.editar',function(e){ 
	  e.preventDefault();
	  $(this).parent('.editarficha').submit();
	 });
	...
	var oTable = $("#tabla_general").dataTable();
	 oTable.on('click', '.activar',function(e){ 
	  e.preventDefault();
	  $(this).parent('.activarf').submit();
	 });

	var oTable = $("#tabla_general").dataTable();
	 oTable.on('click', '.desactivar',function(e){ 
	  e.preventDefault();
	  $(this).parent('.desactivarf').submit();
	 });
		...
		beforeShow: function(){
				...
				$(".pasos").steps({
					...
					onStepChanged: function (event, currentIndex)
					{
						...
						if ( ! $.fn.DataTable.isDataTable( '#tablaBuscar2' ) ) {
  							var table = $('#tablaBuscar2').DataTable({
						...
						if ( ! $.fn.DataTable.isDataTable( '#tablaBuscar3' ) ) {
  							var table = $('#tablaBuscar3').DataTable({
						...
						if ( ! $.fn.DataTable.isDataTable( '#tablaBuscar4' ) ) {
  							var table = $('#tablaBuscar4').DataTable({
						...
						if ( ! $.fn.DataTable.isDataTable( '#tablaBuscar5' ) ) {
  							var table = $('#tablaBuscar5').DataTable({
						...
						drawChart(); // REcalcular tamaño de Charts de google, aqui tendria que poner cada uno de los CHARTS que vaya a utilizar en FancyBox
